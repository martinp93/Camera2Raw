 ...
 * <p> There is no use of this in any type of image processing, but to serve as a type of API glossary.
 * <p> Although there is already an index page in generated javadocs, this will be a placeholder for the terms used as not to cause confusion within other classes.
 * <p> The terms listed are set to a data type in which it most likely will be represented as. Other terms will be set as String (just plain text).
 */
public class Terminology {

  /**
   * The format integer pixel values are stored where each letter represents a color channel.
   * <p> A - Alpha
   * <p> R - Red
   * <p> G - Green
   * <p> B - Blue
  ...
  */
  public int COLOR_CHANNEL, COLOR_COMPONENT;

  /**
  * An integer pixel contains the color information of a pixel.
  * <p>
  ...
  */
  public int INTEGER_PIXEL, INTEGER_PIXEL_VALUE;
  ...
  */
  ...
  /**
   * Linear values in this API refers to decimal values spanning from [0 , 1].
   * <p>Is the result of a normalize-operation.
   * @see #NORMALIZE
   */
  public float LINEAR_VALUE;
