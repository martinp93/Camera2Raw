...
/**
 * A wrapper class for matrices containing integer pixel values. Contains various operations relevant to image processing.
 */
...
*/
  ...
  public CompositeImage(double[][] matrix) {
    ...
    pixelMatrix = Tools.convertToARGB(matrix);
	}
