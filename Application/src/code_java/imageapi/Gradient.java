...
/**
 * The Gradient class contains methods for gradient analysis and getting an image representation of this.
 */
public class Gradient extends ImageOperation {
  ...
  private static int[][] gradientsToPixels(float[][] gradientMap) {
...
/*
  public static Bitmap getGradient(Bitmap bitmap) {
